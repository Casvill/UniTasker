    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function loadTasks() {
            try {
                ...
                const mapped = await Promise.all(listaActividades.map(async (act)=>{
                    // AQUÍ USAS TU NUEVA URL CON QUERY PARAM
                    const tareasActividad = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])(`/tareas/?actividad=${act.id}`, {
                        method: "GET"
                    });
                    ...
                    return {
                        ...
                        completed: subtasks.length > 0 && subtasks.every((t)=>t.estado === "hecha"),
                        tags: [
                            act.tipo
                        ],
                        subtasks: subtasks
...
//# sourceMappingURL=_c9f63549._.js.map