...
function TasksContent({ refreshKey }) {
    ...
    const [isSheetOpen, setIsSheetOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])();
    ...
    const handleCreateSubtask = async ()=>{
        ...
        try {
            ...
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])("/tareas/", {
                method: "POST",
    ...
    const handleDeleteSubtask = async (id)=>{
        ...
        const oldSelectedActivity = {
            ...selectedActivity
        };
        // Optimistic update
        const updatedSubtasksList = (selectedActivity.subtasks || []).filter((s)=>s.id !== id);
        const allDone = updatedSubtasksList.length > 0 && updatedSubtasksList.every((t)=>t.estado === "hecha");
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])(`/tareas/${id}/`, {
                method: "DELETE"
            });
    ...
    const handleToggleSubtask = async (id)=>{
        ...
        for (const t of tasks){
            const found = t.subtasks.find((s)=>s.id === id);
            if (found) {
                targetTask = t;
                subtask = found;
                break;
        ...
        const updatedSubtasks = targetTask.subtasks.map((s)=>s.id === id ? {
                ...s,
                estado: newEstado
            } : s);
        ...
        const updateLocalState = (tTask, uSubtasks, nCompleted)=>{
            setTasks((prev)=>prev.map((t)=>t.id === tTask.id ? {
                        ...t,
                        subtasks: uSubtasks,
    ...
    const handleMarkAllAsDone = async ()=>{
        ...
        const pendingSubtasks = selectedActivity.subtasks.filter((s)=>s.estado !== "hecha");
        ...
        const updatedSubtasks = selectedActivity.subtasks.map((s)=>({
                ...s,
                estado: "hecha"
            }));
        setSelectedActivity((prev)=>({
        ...
        setTasks((prevTasks)=>prevTasks.map((task)=>task.id === selectedActivity.id ? {
                    ...task,
                    subtasks: updatedSubtasks,
                    completed: true
                } : task));
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])(`/actividades/${selectedActivity.id}/`, {
                method: "PATCH",
                body: JSON.stringify({
                    estado: "hecha"
                })
    ...
    const handleToggleActivity = async (task)=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])(`/actividades/${task.id}/`, {
                method: "PATCH",
                body: JSON.stringify({
                    estado: newEstado
                })
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function loadTasks() {
            try {
                ...
                const actividadesRaw = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])("/actividades/", {
                    method: "GET"
                });
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-sm text-muted-foreground",
                                            children: selectedActivity?.project
                                        }, void 0, false, {
                                            fileName: "[project]/components/tasks/tasks-content.tsx",
                                            lineNumber: 540,
                                            columnNumber: 9
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: selectedActivity?.subtasks?.length > 0 ? selectedActivity.subtasks.map((sub)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                            className: `text-sm font-semibold ${sub.estado === "hecha" ? "line-through text-slate-400" : "text-slate-700"}`,
                                                                            children: sub.nombre
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/components/tasks/tasks-content.tsx",
                                                                            lineNumber: 610,
...
function CreateTaskDialog({ onCreated }) {
    ...
    const onSubmit = async (values)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(e?.message ?? "No se pudo crear la actividad.");
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Dialog"], {
        open: open,
...
//# sourceMappingURL=_8a98660c._.js.map