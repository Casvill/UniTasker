...
"[project]/components/tasks/tasks-content.tsx [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/components/tasks/tasks-content.tsx'\n\nExpression expected");
...
function CreateTaskDialog({ onCreated }) {
    ...
    const onSubmit = async (values)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(e?.message ?? "No se pudo crear la actividad.");
        }
    };
...
_c = CreateTaskDialog;
function ManageTasksDialog({ open, onOpenChange, activity, onActivityUpdate }) {
    _s1();
    ...
    const handleDeleteSubtask = async (id)=>{
        ...
        const updatedSubtasksList = (activity.subtasks || []).filter((s)=>s.id !== id);
    ...
    const handleToggleSubtask = async (id)=>{
        ...
        const updatedSubtasks = activity.subtasks.map((s)=>s.id === id ? {
                ...s,
                estado: newEstado
            } : s);
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])(`/tareas/${id}/`, {
                method: "PATCH",
                body: JSON.stringify({
                    estado: newEstado
                })
    ...
    const handleMarkAllAsDone = async ()=>{
        ...
        const pendingSubtasks = activity.subtasks.filter((s)=>s.estado !== "hecha");
        ...
        const promise = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])(`/actividades/${activity.id}/`, {
            method: "PATCH",
            body: JSON.stringify({
                estado: "hecha"
            })
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: activity?.subtasks?.length > 0 ? activity.subtasks.map((sub)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s1(ManageTasksDialog, "a/fJ9vMJOKKhv4qCvUvh+QoSBJw=");
...
//# sourceMappingURL=_61ab495f._.js.map