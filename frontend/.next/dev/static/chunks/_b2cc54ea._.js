...
function TasksContent({ refreshKey }) {
    ...
    const handleCreateSubtask = async ()=>{
        ...
        try {
            ...
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])("/tareas/", {
                method: "POST",
    ...
    const handleMarkAllAsDone = async ()=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])(`/actividades/${selectedActivity.id}/`, {
                method: "PATCH",
                body: JSON.stringify({
                    estado: "hecha"
                })
    ...
    const handleToggleActivity = async (task)=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])(`/actividades/${task.id}/`, {
                method: "PATCH",
                body: JSON.stringify({
                    estado: newEstado
                })
        ...
        "TasksContent.useEffect": ()=>{
            async function loadTasks() {
                try {
                    ...
                    const mapped = listaActividades.map({
                        "TasksContent.useEffect.loadTasks.mapped": (act)=>({
                                id: act.id,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: selectedActivity?.subtasks?.length > 0 ? selectedActivity.subtasks.map((sub)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(TasksContent, "9pygCouT+ZHoXiuv2U+mebEMmbA=");
_c = TasksContent;
var _c;
...
//# sourceMappingURL=_b2cc54ea._.js.map